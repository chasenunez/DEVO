...
**Data Enrichment and Validation Operator**, version 0.2.1
...
Read the report first. If it says `Valid: YES` and the types and ranges in the iCSV look right for your data, the file is ready for upload.
